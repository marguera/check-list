...
interface ViewImagesTabProps {
  imageUrls: string[];
}

export function ViewImagesTab({ imageUrls }: ViewImagesTabProps) {
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {imageUrls.map((url, index) => (
            <div
              key={index}
              className="border border-white/20 hover:shadow-lg hover:shadow-white/10 overflow-hidden transition-shadow cursor-pointer"
